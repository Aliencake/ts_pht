...
export function MediaBoardDialog(props: MediaBoardDialogProps) {
  ...
  const DeleteMediaMutation = useMutation({
    mutationFn: async (form: z.infer<typeof id_schema>) => {
      const res = await axios.delete('api/media', { data: form });
      return res.data;
    },
    onMutate: async (form) => {
  ...
  const UpdateMediaMutation = useMutation({
    mutationFn: async (form: z.infer<typeof update_array_index_schema>) => {
      const res = await axios.post('api/media', { data: form });
      return res.data;
    },
    onSuccess: () => {
      props.queryClient.invalidateQueries({
  ...
  const AddMediaMutation = useMutation({
    mutationFn: async (form: z.infer<typeof add_media_schema>) => {
      const res = await axios.put('api/media', form);
