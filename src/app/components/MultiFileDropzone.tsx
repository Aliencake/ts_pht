...
const ERROR_MESSAGES = {
  fileTooLarge(maxSize: number) {
    return `Дуже великий обсяг. Макимальний ${formatFileSize(maxSize)}.`;
  },
  fileInvalidType() {
    return 'Нєа, тіки фото та відео.';
  },
  tooManyFiles(maxFiles: number) {
    return `Надто багато файлів, можна тіки ${maxFiles} файлів.`;
  },
  fileNotSupported() {
    return 'Не підтримую таке.';
  },
};
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                ...
                <div className="text-gray-400">
                  перетягни або натисни щоб додати фото
                </div>
              </div>
            </div>
